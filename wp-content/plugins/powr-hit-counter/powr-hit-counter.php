<?php
    ...
    */
    ...
    function powr_hit_counter_menu() {
      add_menu_page( 'POWr Hit Counter', 'POWr Hit Counter', 'manage_options', 'powr-hit-counter-settings', powr_hit_counter_options, 'https://s3-us-west-1.amazonaws.com/powr/platforms/wordpress/16x16_icons/HitCounter.png');
      add_submenu_page( 'powr-hit-counter-settings', 'POWr - Create', 'Create', 'manage_options', 'powr-hit-counter-create', powr_hit_counter_create_options);
      add_submenu_page( 'powr-hit-counter-settings', 'POWr - Manage', 'Manage', 'manage_options', 'powr-hit-counter-manage', powr_hit_counter_manage_options);
      add_submenu_page( 'powr-hit-counter-settings', 'POWr - Help', 'Help', 'manage_options', 'powr-hit-counter-help', powr_hit_counter_help_options);
    }
    function powr_hit_counter_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-hit-counter" src="https://www.powr.io/wp/hit-counter" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-hit-counter"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_hit_counter_create_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-create-hit-counter" src="https://www.powr.io/wp-create/hit-counter?powr_token='.get_option('powr_token').'" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-create-hit-counter"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_hit_counter_manage_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-manage-hit-counter" src="https://www.powr.io/wp-manage/hit-counter" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-manage-hit-counter"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_hit_counter_help_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-help-hit-counter" src="https://www.powr.io/knowledge-base?src=wordpress" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-help-hit-counter"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
  ?>